...
<div id="wrapper">
     <!-- Navigation -->
        ...
        <div id="page-wrapper">
        <div class="graphs">
	     <div class="widget_head">控制主页</div>
		   <div class="widget_4">
                ...
                <div class="follow">
                    <?php if($type==1) 
                    echo  " <div class='col-xs-4 two' align='center'>
	                        <p>用户数量</p>
	                        <span>{$user_num}</span>
	                   		</div>"; 
	                   		?>
		   	 ...
		   	 <div class="panel-heading">
                    <a class="panel-title">设备列表 </a>
                    <h4 class="panel-title"  style="float:right">在线情况</h4>
		   	 	...
		   	 	<div class="online">
		   	 		...
		   	 		?>
		   	 		<span style="float:left"> <button class="btn btn-info" type="button" onclick ="javascript:location.reload()">刷新数据</button></span>
					<span style="float:right"> <button class="btn btn-info" type="button" onclick ="javascript:window.location.href='device.php' ">查看全部设备>></button></span>
				</div>
			 </br>
		   	 </div>
		   	 <?php 
		   	 	if($type==1) 
                    {
                    	echo  " <div class='col-md-4 stats-info stats-info1'>
			                <div class='panel-heading'>
			                    <h4 class='panel-title'>     &nbsp&nbsp用户列表</h4>
			                </div>
	                    ...
	                    $user_count = 0;
		   	 			while($row_user = mysql_fetch_array($get_all_user_result))
		   	 			{
		   	 				...
		   	 				if($user_count >= 7)
		   	 					break;
		   	 				echo "<a href='check_user.php?check_user={$row_user['username']}'><div class='online-top'><li>{$row_user['username']}<div class='text-success pull-right'></div></div></li></a>";
		   	 			}
		   	 			echo "</ul></div></div>";
		   	 			echo " <span style=\"float:right\"> <button class=\"btn btn-info\" type=\"button\" onclick =\"javascript:window.location.href='userlist.php' \">查看全部用户>></button></span>";
	                }
		   	 ?>
